...
# NOTE! Below config only sets general part of GENERIC_PROCESSOR_runtime_config
...
W_GENERIC_PROCESSOR(0, PIPELINE_FORMAT, 0, 2, 1, LIST(`             ', "Post Process Setup Config", "Post Process Runtime Params"))
...
# Pipeline Graph
#
#  host PCM_P --> B0 --> GENERIC_PROCESSOR -> B1 --> sink DAI0

P_GRAPH(pipe-pass-playback-PIPELINE_ID, PIPELINE_ID,
	LIST(`		',
	`dapm(N_BUFFER(0), N_PCMP(PCM_ID))',
	`dapm(N_GENERIC_PROCESSOR(0), N_BUFFER(0))',
	`dapm(N_BUFFER(1), N_GENERIC_PROCESSOR(0))'))
